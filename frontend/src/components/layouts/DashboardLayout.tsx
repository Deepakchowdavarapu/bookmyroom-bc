...
const customerNavigation = [
  ...
  { name: 'Search Listings', href: '/customer/search', icon: BuildingOfficeIcon },
...
const vendorNavigation = [
  ...
  { name: 'Listings', href: '/vendor/listings', icon: BuildingOfficeIcon },
  { name: 'Booking Requests', href: '/vendor/bookings', icon: CalendarIcon },
];
